...
[RAG 是什么](./RAG.md)把“为什么需要 RAG”和“链路怎么拆”讲清楚了。这篇文章继续往代码层走：用 LangChain.js 把 RAG 链路落地，并把检索能力挂到 agent 上。
...
离线阶段的目标，是把“原始文档”变成“可被稳定检索的知识单元”。这一段在 [RAG 是什么](./RAG.md) 里讲过为什么，这里只关心怎么做。
