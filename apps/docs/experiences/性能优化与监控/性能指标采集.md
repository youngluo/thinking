...
- Google 废弃 FP 作为 Core Web Vitals 考核指标，是因为它仅反映"有像素变化"而非"有内容"，过于粗糙。LCP + CLS 的组合能更好地替代它的作用。FP 对白屏排查仍有参考价值——若 FP 有数据但 FCP 为空，说明渲染了但无实际内容。<br />
